...
/* Lato Regular */
import latoRegular from './Gilroy/Gilroy-Regular.ttf';
import latoRegularWoff from './Gilroy/Gilroy-Regular.woff';
import latoRegularWoff2 from './Gilroy/Gilroy-Regular.woff2';
/* Lato SemiBold */
import latoSemiBold from './Gilroy/Gilroy-SemiBold.ttf';
import latoSemiBoldWoff from './Gilroy/Gilroy-SemiBold.woff';
import latoSemiBoldWoff2 from './Gilroy/Gilroy-SemiBold.woff2';
/* Lato Bold */
import latoBold from './Gilroy/Gilroy-Bold.ttf';
import latoBoldWoff from './Gilroy/Gilroy-Bold.woff';
import latoBoldWoff2 from './Gilroy/Gilroy-Bold.woff2';
/* Lato Black */
import latoBlack from './Gilroy/Gilroy-Black.ttf';
import latoBlackWoff from './Gilroy/Gilroy-Black.woff';
import latoBlackWoff2 from './Gilroy/Gilroy-Black.woff2';

const Fonts = createGlobalStyle`
  @font-face {
    font-family: 'FontAwesome';
    src:
      url(${faBrandsLight2}) format("woff2"),
      url(${faBrandsLight}) format("woff");
    font-weight: 400;
    font-style: normal;
  }
  @font-face {
    font-family: 'FontAwesome';
    src:
      url(${faRegularLight2}) format("woff2"),
      url(${faRegularLight}) format("woff");
    font-weight: 400;
    font-style: normal;
  }
  @font-face {
    font-family: 'FontAwesome';
    src:
      url(${faSolidHeavy2}) format("woff2"),
      url(${faSolidHeavy}) format("woff");
    font-weight: 400;
    font-style: normal;
  }
  /* Lato Regular - 400 */
